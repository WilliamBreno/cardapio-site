...
// faturamento a recomendação de plano muda. O Pro nunca aparece aqui: sua
// mensalidade (R$99) fica perto demais da do Scale (R$149,90) pra ele
// vencer o Basic antes do Scale assumir — ver o comentário de
// FATURAMENTO_MAX_SIMULADOR em lib/planos.ts.
    ...
    <div style={temaPlanos} className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-2xl px-6 pb-24 pt-16">
        ...
        <div className="mt-2 flex items-start gap-2 rounded-xl bg-card px-4 py-3 ring-1 ring-border">
          <span className="text-muted-foreground">ⓘ</span>
          <p className="text-xs text-muted-foreground">
            O Pro não aparece no mapa de faixas acima porque nunca é o mais barato dos três — sua mensalidade
            fica perto demais da do Scale pra vencer o Basic antes do Scale assumir. Ele continua valendo a pena
            pra quem quer os mesmos recursos do Scale (rastreamento em tempo real, avisos automáticos) com uma
            mensalidade menor e sem compromisso de alto volume, não pelo preço da taxa por pedido.
          </p>
        </div>
